...
'@
    ...
    Describe ConvertTo-X509Certificate2 {
        BeforeAll {
        ...
        Context 'Default' {
            ...
            It 'Should throw without enough parameters with pfx' {
                $Path = "$PSScriptRoot{0}..{0}..{0}helpers{0}scomnewbie.pfx" -f $DS
            ...
            It 'Should throw with good parameter pfx but bad secret' {
                $WinPath = "$PSScriptRoot{0}..{0}..{0}helpers{0}scomnewbie.pfx" -f $DS
                $LinPath = "$PSScriptRoot{0}..{0}..{0}helpers{0}scomnewbie.pem" -f $DS
            ...
            It 'Should throw with good file but encrypted private key' {
                $Path = "$PSScriptRoot{0}..{0}..{0}helpers{0}scomnewbie2.pem" -f $DS
            ...
            It 'Should not throw with good file and decrypted private key' {
                $Path = "$PSScriptRoot{0}..{0}..{0}helpers{0}scomnewbie2.pem" -f $DS
                $PathKey = "$PSScriptRoot{0}..{0}..{0}helpers{0}privatekey_rsa.key" -f $DS
